...
class RunwayService:
    ...
    def create_video_pareja(self, image_url: bytes) -> bytes:
        ...
        prompt_vid = ("a romantic couple walking share a gesture of affection, such as an exchange of glances and a warm smile. Preservation of the facial and bodily appearance of the people, soft lighting, cinematic style, 24fps, smooth camera movement")
